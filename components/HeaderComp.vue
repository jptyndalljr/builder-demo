<template>
	<header class="site-header">
		<nav class="hidden md:flex">
			<ul
				class="desktop md:flex md:flex-row md:grow md:justify-between md:space-between md:items-center px-8">
				<div
		...
		<nav class="flex flex-row justify-between md:hidden relative">
			<nuxt-link to="/" class="p-3"
				><img :src="doc.logo.url" :alt="doc.logo.alt" class="nav-logo"
			/></nuxt-link>
			<font-awesome-icon
