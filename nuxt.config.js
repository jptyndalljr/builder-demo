...
export default {
	...
	head: {
		...
		meta: [
			...
			{ hid: 'description', name: 'description', content: 'brand builders, cultural instigators and do gooders whose job is to help brands find their conviction and turn it into action for people.', },
